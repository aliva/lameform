...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Main.edu'
        db.alter_column(u'lameform_main', 'edu', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Main.edu'
        db.alter_column(u'lameform_main', 'edu', self.gf('django.db.models.fields.TextField')(default=''))
