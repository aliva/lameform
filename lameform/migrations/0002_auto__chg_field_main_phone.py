...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Main.phone'
        db.alter_column(u'lameform_main', 'phone', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Main.phone'
        db.alter_column(u'lameform_main', 'phone', self.gf('django.db.models.fields.TextField')(default=''))
